...
class mod_forum_post_form extends moodleform {
    ...
    function definition() {
		...
		if (forum_is_anonymous($forum->id) && $manageactivities) {
			$noticehtml = '<span style="font-weight:bold;color:#cf1d1d;">'.
							'Ihr Beitrag wird mit Namen gepostet, '.
							'da Sie als Lehrende(r) eingeschrieben sind.'.
							'</span>';
			$mform->addElement('static', 'notice', 'Hinweis', $noticehtml);
		}
		// UDE-HACK end
